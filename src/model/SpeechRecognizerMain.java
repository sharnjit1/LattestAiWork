						...
						if (!ignoreSpeechRecognitionResults) {
							...
							if (speechResult == null)
								...
								System.out.println("You said: [" + speechRecognitionResult + "]\n");
                                                               ...
                                                               if(speechRecognitionResult.equalsIgnoreCase("open my app"))
                                                               {
                                                                   ...
                                                                   new Login();
                                                                    ...
                                                                    if(speechRecognitionResult.equalsIgnoreCase("secure my text"))
                                                                    {
                                                                        text=EncryptionExample.encrypt(text,78 );
                                                                    ...
                                                                    /*if(speechRecognitionResult.equalsIgnoreCase("encrypt"))
                                                                        {                                                                          
                                                                            text=speechRecognitionResult;
                                                                            text=EncryptionExample.encrypt(text,78);
                                                                            new Window(text);
